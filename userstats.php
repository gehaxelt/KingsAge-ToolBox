<?php
session_start();
$masterpw="xxxxxxxxxxxxxxxa3290";
mysql_connect("xxxxxxxxx.de","xxxxxxxx1","xxxxxxxxx23") or die ("Keine Verbindung moeglich");
mysql_select_db("Dxxxxxxxxxxxx") or die ("Die Datenbank existiert nicht");
...
if(isset($_GET['action'])) {
	if($_GET['action']=="login") {
		$user=$_POST['username'];
		$pass=$_POST['password'];
		if(($user=="xxxxxn" || $user=="xxxxxxxxxxi") && $masterpw == md5($pass)) {
			$_SESSION['user']=$user;
