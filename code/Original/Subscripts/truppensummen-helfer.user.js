		...
		if(abfrage) {
			try {
				...
				if(span > 5) {
					...
					document.evaluate("/html/body/div[2]/table/tbody/tr/td[2]/table/tbody/tr[2]/td/div[6]/div/table[2]/tbody/tr[2]", document, null,XPathResult.ANY_TYPE, null).iterateNext().innerHTML+="<th></th>";
					var i=2
				} else {
					document.evaluate("/html/body/div[2]/table/tbody/tr/td[2]/table/tbody/tr[2]/td/div[6]/div/table[2]/tbody/tr", document, null,XPathResult.ANY_TYPE, null).iterateNext().innerHTML+="<th></th>";
					var i=1
				}
				do {
					i++
					...
					if (result) {
						...
						if(regex.exec(name)) {
							...
							document.evaluate("/html/body/div[2]/table/tbody/tr/td[2]/table/tbody/tr[2]/td/div[6]/div/table[2]/tbody/tr["+i+"]", document, null,XPathResult.ANY_TYPE, null).iterateNext().innerHTML+="<td><a href='"+url+"' target='_blank'>Eintragen</a></td>";
						}
					} else
					{
						document.evaluate("/html/body/div[2]/table/tbody/tr/td[2]/table/tbody/tr[2]/td/div[6]/div/table[2]/tbody/tr["+i+"]", document, null,XPathResult.ANY_TYPE, null).iterateNext().innerHTML+="<td></td>";
						break;
					}
				} while(result!=null);
			} catch(e) {}
